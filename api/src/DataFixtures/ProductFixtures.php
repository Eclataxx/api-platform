...
class ProductFixtures extends Fixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $product1 = new Product("iPhone X 64GB - Space Gray Unlocked", $loremIpsum, 299, "TO SELL");
        $product2 = new Product("iPhone SE (2020)", $loremIpsum, 329, "TO SELL");
        $product3 = new Product("Samsung Galaxy S8", $loremIpsum, 149, "TO SELL");
        $product4 = new Product("Samsung Galaxy S7", $loremIpsum, 109, "TO SELL");
